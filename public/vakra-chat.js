...
document.addEventListener("DOMContentLoaded", () => {
    ...
    chatStyles.innerHTML = `
        /* Yahan wahi saari CSS rules aayengi jo humne final fixed window aur trigger ki final ki thi */
        #chatTrigger {
            ...
            cursor: pointer !important; z-index: 999999 !important; display: flex !important; align-items: center !important; justify-content: center !important;
        ...
        .vakra-chat-window {
            ...
            border-radius: 20px !important; z-index: 99999999 !important; overflow: hidden !important; box-sizing: border-box !important;
    ...
    sendBtn.addEventListener('click', dispatchUserPrompt);
    inputEl.addEventListener('keydown', (e) => { if (e.key === 'Enter') dispatchUserPrompt(); });
});